...
impl IInstanceComponent for ServiceProviderComponent {
    fn lua_get(
        ...
        match key.as_str() {
            ...
            "GetService" => lua_getter!(function_opt, lua, |_,
                                                            (this, name): (
                ManagedInstance,
                String
            )| {
                ...
                unsafe { i.unwrap_unchecked().get_service(name) }
            }),
            "FindService" => lua_getter!(function_opt, lua, |_,
                                                             (this, name): (
                ManagedInstance,
                String
            )| {
                ...
                unsafe { i.unwrap_unchecked().find_service(name) }
            }),
            _ => None,
        }
    }
